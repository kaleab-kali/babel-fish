...
Offline demo fixtures for Babel Fish.

This package provides deterministic transcript and translation data so the app can demonstrate the caption flow without network access, provider credentials, or real user audio.
