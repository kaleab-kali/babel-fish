...
The app currently supports fixture-backed language pair selection for English, French, and Amharic demo data. Translated captions can be copied from the demo flow, completed translations are shown in a clearable in-session history list, and the UI clearly marks the demo as offline fixture mode.
