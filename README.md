...
`app` is the Flutter demo that connects the packages into a fixture-backed caption experience with deterministic language-pair selection, translated-text copy support, in-session caption history, and a visible offline fixture-mode status.
