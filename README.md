...
`app` is the Flutter demo that connects the packages into a fixture-backed caption experience with deterministic language-pair selection and translated-text copy support.
